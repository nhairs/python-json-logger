...
### Changed
- Add runnable Quick Start examples and JSON outputs explaining defaults, static fields, and field precedence. [#36](https://github.com/nhairs/python-json-logger/issues/36)

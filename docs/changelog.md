...
### Added
- Cookbook recipe for sending JSON through `SysLogHandler`, with a local UDP receiver and notes on syslog framing and `HTTPHandler`. [#42](https://github.com/nhairs/python-json-logger/issues/42)
